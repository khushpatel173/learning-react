...
function Card(props){
  ...
  <div className="sm:flex sm:justify-between sm:gap-4 lg:gap-6">
    <div className="sm:order-last sm:shrink-0">
      <img alt="" src="https://images.unsplash.com/photo-1633332755192-727a05c4013d?auto=format&amp;fit=crop&amp;q=80&amp;w=1160" className="size-16 rounded-full object-cover sm:size-18"/> 
    </div>
    ...
    <div className="mt-4 sm:mt-0">
      ...
      <p className="mt-1 text-sm text-gray-700">{props.username}</p>
